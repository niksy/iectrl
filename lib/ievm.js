...
var IEVM, Q, child_process, debug, fs, https, path, url, os,
...
IEVM = (function() {
  ...
  IEVM.versions = ['8', '9', '10', '11', 'EDGE'];

  IEVM.oses = ['Win7', 'Win8', 'Win10'];

  IEVM.names = ['IE8 - Win7', 'IE9 - Win7', 'IE10 - Win7', 'IE10 - Win8', 'IE11 - Win7', 'MSEdge - Win10'];
  ...
  IEVM.ievmsUrl = (_ref2 = process.env.IEVMS_URL) != null ? _ref2 : 'https://raw.githubusercontent.com/amichaelparker/ievms/master/ievms.sh';
  ...
  IEVM.ievms = function(env, debug) {
    ...
    if (debug != null) {
      ievms.stdout.on('readable', function() {
        ...
        if (out != null) {
          _ref2 = out.toString().trim().split(os.EOL);
          _results = [];
  ...
  IEVM.find = function(name) {
    ...
    if (!name.match(/^\d+$/) || __indexOf.call(this.versions, name) < 0) {
      throw new Error("Invalid name: '" + name + "'");
    }
    _ref2 = this.names;
    _results = [];
  ...
  IEVM.parseHdds = function(s) {
    ...
    hdds = {};
    _ref2 = s.split(os.EOL + os.EOL);
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      chunk = _ref2[_i];
      hdd = {};
      _ref3 = chunk.split(os.EOL);
  ...
  IEVM.prototype.close = function() {
    ...
    return this.ensureNotMissing().then(function() {
      return _this.ensureRunning().then(function() {
        var cmd;
        _this.debug('close');
        cmd = _this.version === 'EDGE' ? 'MicrosoftEdge.exe' : 'iexplore.exe';
        return _this.exec('taskkill.exe', '/f', '/im', cmd).fail(function() {
          return Q(true);
        });
      });
    });
      ...
      return _this.ensureRunning().then(function() {
        return _this.waitForGuestControl().then(function() {
          return _this.ievmsVersion().then(function(version) {
            ...
            args = ['--username', 'IEUser'].concat(__slice.call(pass), ['run'], [cmd], ['--'], __slice.call(args));
  ...
  IEVM.prototype.archive = function() {
    var _ref2, _ref3;
    if ((_ref2 = this.name) === 'IE8 - Win7') {
      return 'IE8/IE8.Win7.VirtualBox.zip';
    }
    if ((_ref3 = this.name) === 'IE10 - Win7' || _ref3 === 'IE11 - Win7') {
      return 'IE9/IE9.Win7.VirtualBox.zip';
    }
  ...
  IEVM.prototype.ova = function() {
    ...
    if (this.name === 'MSEdge - Win10') {
      return 'MSEdge - Win10_preview.ova';
    }
  ...
  IEVM.prototype.url = function() {
    if (this.os === 'Win10') {
      return 'https://az792536.vo.msecnd.net/vms/VMBuild_20180425/VirtualBox/MSEdge/MSEdge.Win10.VirtualBox.zip';
    }
    if (this.os === 'Win8') {
      return 'https://az792536.vo.msecnd.net/vms/VMBuild_20180102/VirtualBox/IE11/IE11.Win81.VirtualBox.zip';
    }
    return 'https://az792536.vo.msecnd.net/vms/VMBuild_20150916/VirtualBox/' + this.archive();
  };
